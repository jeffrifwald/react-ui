...
var _srcAjaxForm = require('../../../src/AjaxForm');

var _srcAjaxForm2 = _interopRequireDefault(_srcAjaxForm);
...
exports['default'] = {
    code: ['<AjaxForm action="http://httpbin.org/post" onResponse={onResponse}>', '    <input name="message" placeholder="message" type="text" />', '    <button type="submit">Send Message</button>', '</AjaxForm>'].join('\n'),
    name: 'AjaxForm',
    rendered: React.createElement(
        _srcAjaxForm2['default'],
        { action: 'http://httpbin.org/post', onResponse: onResponse },
        React.createElement('input', { name: 'message', placeholder: 'message', type: 'text' }),
        React.createElement(
            'button',
            { type: 'submit' },
            'Send Message'
...
},{"../../../src/AjaxForm":6}],2:[function(require,module,exports){
'use strict';
...
},{"./AjaxForm":1}],3:[function(require,module,exports){
(function (global){
'use strict';
...
var DocsApp = (function (_React$Component) {
    function DocsApp() {
        ...
        _get(Object.getPrototypeOf(DocsApp.prototype), 'constructor', this).apply(this, arguments);
    }

    _inherits(DocsApp, _React$Component);

    _createClass(DocsApp, [{
        ...
        key: 'renderInstallation',
        value: function renderInstallation() {
        ...
        value: function renderComponents() {
            var renderedComponents = _components2['default'].map(function (component, i) {
                return _react2['default'].createElement(
                    'div',
...
_react2['default'].render(_react2['default'].createElement(DocsApp, null), document.querySelector('.render'));

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"../../src/ReactUI":7,"./components":2}],4:[function(require,module,exports){
module.exports={
  "name": "react-ui",
  "version": "0.4.0",
...
},{"./components/AjaxForm":5}],7:[function(require,module,exports){
'use strict';
...
},{"../package.json":4,"./AjaxForm":6}],8:[function(require,module,exports){
(function (global){
'use strict';
